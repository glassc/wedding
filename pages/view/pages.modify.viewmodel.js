define(['knockout', 'jquery',  "alertify", 'amplify','/admin/pages/gallery.viewmodel.js','kovalidation', 'ko.ckeditor', 'kocommand', 'kosortable'], function(ko, $, alertify, amplify, GalleryViewModel)
{
        ...
        self.save = ko.command({
            execute: function() {
                ...
                $.ajax({
                    ...
                    alertify.success(self.title() + " was saved successfully");
